# CrowdSift Bootstrap Design

## Goal

Create the smallest runnable CrowdSift web project and connect the existing workspace to the empty GitHub repository at `https://github.com/junyoung-code/CrowdSift.git`.

## Scope

- Keep `docs/CrowdSift_Project_Context_v1.0.pdf` in place.
- Use Next.js App Router, TypeScript, Tailwind CSS, and ESLint.
- Render one responsive landing screen with the CrowdSift name, a short Korean product description, and a visible `YouTube 연결하기` call to action.
...
- `app/page.tsx`: the minimal CrowdSift start screen.
